<template>
  <div class="collaborator-card pending-card">
    ...
    <!-- Avatar (Placeholder for pending) -->
    ...
    <div class="info-container">
      ...
      <p class="role">Invitation envoyée</p>
    </div>
...
.collaborator-card {
  ...
  border: 1px dashed #d1d5db; /* Dashed border for pending */
