<template>
  <aside class="sidebar" :class="{ 'is-reduced': isReduced }">
    ...
    <div class="logo hidden-mobile">
        ...
        <span class="logo-text" v-if="!isReduced">Paramètres</span>
    ...
    <nav class="nav-menu">
      <button
        class="nav-item"
        :class="{ active: route.path.includes('/Dashboard/index/ ') || route.path === '/dashboard/settings' }"
      ...
      >
        ...
        <span class="nav-label" v-if="!isReduced">Information générales</span>
      </button>

      <button
        class="nav-item"
        :class="{ active: route.path.includes('/collaborators') }"
        @click="router.push('/dashboard/settings/collaborators')"
      >
        ...
        <span class="nav-label" v-if="!isReduced">Mes collaborateurs</span>
      </button>
    </nav>
